...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Run ResNet-50 breast US experiment under different artifact filters "
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "  egregious_020 = drop frac_lesion_covered > 0.20\n"
    ...
    default_keep_paths = {
        ...
        "egregious_020": Path("/workspace/artifact_filter_020/kept_images.txt"),
    }
    ...
    bench.MODEL_NAMES = [args.model]
    bench.EXPERIMENTS = [
        {"ratio": 0.0, "type": "uniform", "name": f"baseline_artifacts_{args.filter_mode}"}
    ]
    bench.NUM_FOLDS = args.num_folds
    bench.SCRIPT_VERSION = f"{bench.SCRIPT_VERSION}_artifacts_{args.filter_mode}"

    print("\n====== Artifact-aware ResNet-50 experiment ======")
